...
export const ICONS = {
  ...
  /* ——— дерево прокачки ——— */
  // правая половина щита чуть темнее — иначе он читается как плоский значок
  shield: F(
    '<path d="M12 2.6 19.6 5.4v6.2c0 4.7-3.2 8.3-7.6 9.8-4.4-1.5-7.6-5.1-7.6-9.8V5.4L12 2.6Z"/>' +
      '<path d="M12 2.6 19.6 5.4v6.2c0 4.7-3.2 8.3-7.6 9.8V2.6Z" fill="#000" fill-opacity=".14"/>',
  ),
  bag: F(
    '<path d="M8.8 3.2c1 .6 2 .9 3.2.9s2.2-.3 3.2-.9l-1.5 3.6h-3.4L8.8 3.2Z"/>' +
      '<path d="M10.1 7.6h3.8c3.4 2.2 6.1 5.4 6.1 8.6 0 3.2-2.8 5-8 5s-8-1.8-8-5c0-3.2 2.7-6.4 6.1-8.6Z"/>' +
      '<path d="M12 11v7M14 12.5c-.5-.6-1.2-.9-2-.9-1.1 0-1.9.6-1.9 1.4 0 1.9 3.9 1 3.9 2.9 0 .8-.9 1.4-2 1.4-.8 0-1.6-.3-2.1-.9" stroke="#000" stroke-opacity=".3" stroke-width="1.4" fill="none"/>',
  ),
  // подкова рожками вверх — так она «держит» удачу
  horseshoe: F(
    '<path d="M4.6 3.8h3.6v7.4a3.8 3.8 0 0 0 7.6 0V3.8h3.6v7.4a7.4 7.4 0 0 1-14.8 0V3.8Z"/>' +
      '<g fill="#000" fill-opacity=".3"><circle cx="6.4" cy="6.4" r=".95"/><circle cx="6.5" cy="10.4" r=".95"/>' +
      '<circle cx="17.6" cy="6.4" r=".95"/><circle cx="17.5" cy="10.4" r=".95"/>' +
      '<circle cx="8.9" cy="15.9" r=".95"/><circle cx="15.1" cy="15.9" r=".95"/></g>',
  ),
  hourglass: F(
    '<path d="M6.2 2.6h11.6a1 1 0 0 1 0 2h-.6v1.2c0 2.4-1.5 4.3-3.6 6.2 2.1 1.9 3.6 3.8 3.6 6.2v1.2h.6a1 1 0 0 1 0 2H6.2a1 1 0 0 1 0-2h.6v-1.2c0-2.4 1.5-4.3 3.6-6.2-2.1-1.9-3.6-3.8-3.6-6.2V4.6h-.6a1 1 0 0 1 0-2Z"/>' +
      '<path d="M9 18.4c.3-1.6 1.5-2.6 3-3.4 1.5.8 2.7 1.8 3 3.4H9ZM9.6 7.4h4.8c-.5.9-1.3 1.7-2.4 2.6-1.1-.9-1.9-1.7-2.4-2.6Z" fill="#000" fill-opacity=".28"/>',
  ),
  // перо — калам книжника
  feather: F(
    '<path d="M20 3.2c-6.6.3-11.6 4.4-13 11.2L5 20.2l1.5.6 2.2-5.4C14.4 14.8 19.4 9.9 20 3.2Z"/>' +
      '<path d="m8.6 15.3 7-7" stroke="#000" stroke-opacity=".3" stroke-width="1.3" fill="none"/>',
  ),
  key: F(
    '<circle cx="8" cy="12" r="4.8"/>' +
      '<path d="M12 10.6h9v2.8h-1.8v2.4h-2.6v-2.4H12v-2.8Z"/>' +
      '<circle cx="8" cy="12" r="1.8" fill="#000" fill-opacity=".3"/>',
  ),

  /* ——— снаряжение ——— */
  up: F(
    '<circle cx="12" cy="12" r="9"/>' +
      '<path d="M12 16.6V7.8M8 11.6l4-4 4 4" stroke="#fff" stroke-width="2.6" fill="none"/>',
  ),
  // осколки — то, во что превращаются повторные находки
  shards: F(
    '<path d="M4.8 9.6 8.6 5.2l3 3.4-2.6 5.4-4.2-4.4Z"/>' +
      '<path d="M13.2 4.2h5.2l1.6 4.4-4.8 2.4-2-6.8Z"/>' +
      '<path d="m10.4 14.6 5.2-2.6 3.4 4.4-4.6 4.4-4-6.2Z"/>' +
      '<path d="m8.6 5.2 3 3.4M13.2 4.2l2 6.8M15.6 12l-1.2 8.8" stroke="#000" stroke-opacity=".22" stroke-width="1" fill="none"/>',
  ),
  // тоқӣ — таджикская тюбетейка: купол на жёстком околыше
  hat: F(
    '<path d="M4.4 15.4c0-4.9 3.4-9 7.6-9s7.6 4.1 7.6 9v.8H4.4v-.8Z"/>' +
      '<rect x="3.2" y="15.6" width="17.6" height="3.4" rx="1.3"/>' +
      '<path d="M12 6.6v9M7.4 8.8l1.6 6.8M16.6 8.8 15 15.6" stroke="#000" stroke-opacity=".22" stroke-width="1.3" fill="none"/>',
  ),
  necklace: F(
    '<path d="M4.4 3.8c0 6.6 3.3 10.8 7.6 10.8s7.6-4.2 7.6-10.8" stroke="currentColor" stroke-width="2.2" fill="none"/>' +
      '<path d="M12 13.8 15.4 17.6 12 21.4 8.6 17.6 12 13.8Z"/>' +
      '<circle cx="6.1" cy="9.6" r="1.4"/><circle cx="17.9" cy="9.6" r="1.4"/>',
  ),
  // тумор — треугольный оберег на шнурке, каким его носят в Средней Азии
  amulet: F(
    '<circle cx="12" cy="3.6" r="1.7" fill="none" stroke="currentColor" stroke-width="1.7"/>' +
      '<path d="M3.8 6.2h16.4L12 21 3.8 6.2Z"/>' +
      '<path d="M8.4 8.8h7.2L12 15.4 8.4 8.8Z" fill="#000" fill-opacity=".22"/>',
  ),
  // анор — гранат, в Средней Азии знак достатка
  pomegranate: F(
    '<path d="M12 6.6c4.6 0 8 3.2 8 7.4s-3.4 7.4-8 7.4-8-3.2-8-7.4 3.4-7.4 8-7.4Z"/>' +
      '<path d="m9.4 7-.5-3.4 1.9 1.3L12 2.8l1.2 2.1 1.9-1.3-.5 3.4H9.4Z"/>' +
